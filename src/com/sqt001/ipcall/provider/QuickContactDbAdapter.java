 ...
 */
public class QuickContactDbAdapter {
    public static final String KEY_NAME = "name";
    public static final String KEY_NUMBER = "number";
    public static final String KEY_ROWID = "_id";

    private static final String TAG = "quickDbAdapter";
    ...
    private static final String DATABASE_NAME = "quick_contact_db";
     ...
     */
    public QuickContactDbAdapter(Context ctx) {
        this.mCtx = ctx;
    }
     ...
     */
    public QuickContactDbAdapter open() throws SQLException {
     ...
     */
    public long createlog(QuickContact entry) {
     ...
     */
    public boolean updatelog(long rowId, QuickContact entry) {
