...
public class ContactsListActivityXX extends ListActivity {
  ...
  public boolean onKeyDown(int keyCode, KeyEvent event) {
    ...
    if (keyCode == KeyEvent.KEYCODE_BACK) {
      Intent intent = new Intent(ContactsListActivityXX.this, DialtactsActivity.class);
  ...
  private SimpleCursorAdapter getContactAdapter(Cursor c) {
    ...
    return new SimpleCursorAdapter(this, android.R.layout.simple_list_item_1, c, columns,
  ...
  private void popupNumbersListForCall(int position) {
    ...
    Toast.makeText(ContactsListActivityXX.this, names[0], Toast.LENGTH_LONG).show();
    if (numbers == null) {
      return;
    }
  ...
  private final Tuple<String[]> getContact(int position) {
    ...
    String[] numAry = NumberQueryer.create(cursor, this).query();
