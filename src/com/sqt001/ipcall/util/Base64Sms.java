...
public class Base64Sms {
  private char[] CA = "abcdVWXefgQRSTUYZhijKLMNOPuvwxyzGHIJklmnopDEFstABCqr2345601789!."
      .toCharArray();
  ...
  public static final String encode(String s) {
    // Reuse char[] since we can't create a String incrementally anyway and
    // StringBuffer/Builder would be slower.
      Base64Sms encoder = new Base64Sms();
  ...
  public static final String encode(String s, String table) {
      // Reuse char[] since we can't create a String incrementally anyway and
      // StringBuffer/Builder would be slower.
      Base64Sms encoder = new Base64Sms(table);
      return encode(encoder, s);
  }
  
  public static final String encode(Base64Sms encoder, String s) {
      // Reuse char[] since we can't create a String incrementally anyway and
      // StringBuffer/Builder would be slower.
      try {
  ...
  public static String decode(String s) throws UnsupportedEncodingException {
      Base64Sms decoder = new Base64Sms();
  ...
  public static String decode(String s, String table) throws UnsupportedEncodingException {
      Base64Sms decoder = new Base64Sms(table);
      return new String(decoder.decodeFast(s), "UTF-8");
  }
}
